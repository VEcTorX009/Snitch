...
const OnboardingData = () => {
  ...
  const handleLogin = () => {
    ...
    // Once login is successful, navigate to the desired screen
  ...
  return (
    <View style={[styles.container, { width }]}>
      <Carousel>
        <Image source={require("../assets/onboard1.png")} style={[styles.image, { width, resizeMode: 'cover' }]} />
        <Image source={require("../assets/onboard2.png")} style={[styles.image, { width, resizeMode: 'cover' }]} />
        <Image source={require("../assets/onboard3.png")} style={[styles.image, { width, resizeMode: 'cover' }]} />
      </Carousel>
